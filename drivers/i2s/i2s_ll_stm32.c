...
static inline unsigned int div_round_closest(u32_t dividend, u32_t divisor)
{
...
static inline int i2s_stm32_enable_clock(struct device *dev)
{
...
static u32_t i2s_stm32_irq_count = 0;

static void i2s_stm32_isr(void *arg)
{
	struct device *const dev = (struct device *) arg;
	const struct i2s_stm32_cfg *cfg = dev->config->config_info;
	//struct i2s_stm32_data *const dev_data = DEV_DATA(dev);
	//struct stream *stream = &dev_data->rx;
...
static int i2s_stm32_initialize(struct device *dev)
{
	...
	if ((ret = i2s_stm32_enable_clock(dev)) < 0) {
...
static const struct i2s_stm32_cfg i2s_stm32_config_1 = {
	.i2s = (SPI_TypeDef *) CONFIG_SPI_1_BASE_ADDRESS,
	.pclken = {
...
static void i2s_stm32_irq_config_func_1(struct device *dev)
{
	SYS_LOG_DBG("Enable I2S1 IRQ");
	IRQ_CONNECT(CONFIG_SPI_1_IRQ, CONFIG_SPI_1_IRQ_PRI, i2s_stm32_isr,
...
static const struct i2s_stm32_cfg i2s_stm32_config_2 = {
	.i2s = (SPI_TypeDef *) CONFIG_SPI_2_BASE_ADDRESS,
	.pclken = {
...
static void i2s_stm32_irq_config_func_2(struct device *dev)
{
	SYS_LOG_DBG("Enable I2S2 IRQ");
	IRQ_CONNECT(CONFIG_SPI_2_IRQ, CONFIG_SPI_2_IRQ_PRI, i2s_stm32_isr,
...
static const struct i2s_stm32_cfg i2s_stm32_config_3 = {
	.i2s = (SPI_TypeDef *) CONFIG_SPI_3_BASE_ADDRESS,
	.pclken = {
...
static void i2s_stm32_irq_config_func_3(struct device *dev)
{
	SYS_LOG_DBG("Enable I2S3 IRQ");
	IRQ_CONNECT(CONFIG_SPI_3_IRQ, CONFIG_SPI_3_IRQ_PRI, i2s_stm32_isr,
...
static const struct i2s_stm32_cfg i2s_stm32_config_4 = {
	.i2s = (SPI_TypeDef *) CONFIG_SPI_4_BASE_ADDRESS,
	.pclken = {
...
static void i2s_stm32_irq_config_func_4(struct device *dev)
{
	SYS_LOG_DBG("Enable I2S4 IRQ");
	IRQ_CONNECT(CONFIG_SPI_4_IRQ, CONFIG_SPI_4_IRQ_PRI, i2s_stm32_isr,
		    DEVICE_GET(i2s_stm32_4), 0);
	irq_enable(CONFIG_SPI_4_IRQ);
}
...
static const struct i2s_stm32_cfg i2s_stm32_config_5 = {
	.i2s = (SPI_TypeDef *) CONFIG_SPI_5_BASE_ADDRESS,
	.pclken = {
...
static void i2s_stm32_irq_config_func_5(struct device *dev)
{
	SYS_LOG_DBG("Enable I2S5 IRQ");
	IRQ_CONNECT(CONFIG_SPI_5_IRQ, CONFIG_SPI_5_IRQ_PRI, i2s_stm32_isr,
		    DEVICE_GET(i2s_stm32_5), 0);
	irq_enable(CONFIG_SPI_5_IRQ);
}

#endif /* CONFIG_I2S_5 */

static inline struct device *get_dev_from_rx_dma_channel(u32_t dma_channel)
{
	return active_dma_rx_channel[dma_channel];
}

static inline struct device *get_dev_from_tx_dma_channel(u32_t dma_channel)
{
