...
static int iis3dhhc_init_chip(struct device *dev)
{
	...
	iis3dhhc_data_rate_set(data->ctx, CONFIG_IIS3DHHC_NORM_MODE);
...
static const struct iis3dhhc_config iis3dhhc_config = {
	...
	.gpio_cs_port	    = DT_INST_0_ST_IIS3DHHC_CS_GPIO_CONTROLLER,
	.cs_gpio	    = DT_INST_0_ST_IIS3DHHC_CS_GPIO_PIN,
