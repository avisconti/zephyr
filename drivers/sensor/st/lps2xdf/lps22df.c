...
static inline void lps22df_press_convert(const struct device *dev,
...
static inline void lps22df_temp_convert(const struct device *dev,
					struct sensor_value *val,
					int16_t raw_val)
{
...
const struct lps2xdf_chip_api st_lps22df_chip_api = {
	...
	.press_convert = lps22df_press_convert,
	.temp_convert = lps22df_temp_convert,
