...
static int iis2dlpc_init(const struct device *dev)
{
	...
	LOG_INF("PULSE: ths_y is %02x", cfg->pulse_ths[1]);
	...
	LOG_INF("PULSE: ths_z is %02x", cfg->pulse_ths[2]);
	...
	LOG_INF("PULSE: pulse_x_en is %d", cfg->pulse_x_en);
	...
	LOG_INF("PULSE: pulse_y_en is %d", cfg->pulse_y_en);
	...
	LOG_INF("PULSE: pulse_z_en is %d", cfg->pulse_z_en);
...
#ifdef CONFIG_IIS2DLPC_PULSE
	.pulse_trigger = DT_INST_PROP(0, pulse_mode),
	.pulse_ths[0] = DT_INST_PROP(0, pulse_thsx),
	.pulse_ths[1] = DT_INST_PROP(0, pulse_thsy),
	.pulse_ths[2] = DT_INST_PROP(0, pulse_thsz),
	.pulse_x_en = DT_INST_PROP(0, pulse_x_enable),
	.pulse_y_en = DT_INST_PROP(0, pulse_y_enable),
	.pulse_z_en = DT_INST_PROP(0, pulse_z_enable),
	.pulse_shock = DT_INST_PROP(0, pulse_shock),
	.pulse_ltncy = DT_INST_PROP(0, pulse_ltcy),
	.pulse_quiet = DT_INST_PROP(0, pulse_quiet),
#endif /* CONFIG_IIS2DLPC_PULSE */
#endif /* CONFIG_IIS2DLPC_TRIGGER */
};
