...
.dma_##dir = {								\
	.dma_name = DT_INST_##index##_ST_STM32_SPI_##dir_cap##_DMAS_CONTROLLER,		\
	.channel = DT_INST_##index##_ST_STM32_SPI_##dir_cap##_DMAS_CHANNEL,		\
	.dma_cfg = {							\
		.dma_slot = DT_INST_##index##_ST_STM32_SPI_##dir_cap##_DMAS_SLOT,	\
		.channel_direction = STM32_DMA_CONFIG_DIRECTION(	\
			DT_INST_##index##_ST_STM32_SPI_##dir_cap##_DMAS_CHANNEL_CONFIG),	\
	...
	.fifo_threshold = STM32_DMA_FEATURES_FIFO_THRESHOLD(		\
			DT_INST_##index##_ST_STM32_SPI_##dir_cap##_DMAS_FEATURES),	\
},
#else
#define SPI_DMA_CHANNEL_INIT(index, dir, dir_cap, src_dev, dest_dev)	\
.dev_dma_##dir = NULL,
