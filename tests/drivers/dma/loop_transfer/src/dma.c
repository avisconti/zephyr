...
/*
 * This application transfer data with DMA, from one memory location (source)
 * to another(dest) for each DMA channel in the valid range
 * FIRST_DMA_CHANNEL to LAST_DMA_CHANNEL
 */
void main(void)
{
	struct device *dma;
