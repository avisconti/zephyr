...
See configuration in file :file:`samples/boards/96b_argonkey/microphone/src/main.c`:
...
The ttyUSB0 port must be configured in raw mode in order to avoid to have
